            ...
            <div id="container">
                ...
                <nav class="col-sm-2 d-none d-sm-block bg-light sidebar">
                    ...
                    <div class="col-sm-8" id="profile">
                        <h3 class="container-header">Worker Dashboard</h3>
                    ...
                    <br>  
                        ...
                        <c:forEach var="request" items="${requestlist}">
                            <c:if test="${(request.getStatus() ne 'Complete')}">
                                <div class="card">
                            <form action="workersubmitrequest.htm" method="post">
                        ...
                        <div class="card-body">
                                   ...
                                   <br>
                                   Status:
                                    <select class="custom-select mr-sm-2" name="getStatus">
