...
//		logger.info("InnXSS RequestWrapper ..............." + value);
		...
		value = value.replaceAll("(?i)<.*?\\s+on.*?>.*?</.*?>", "");
                value= value.replaceAll("/[/*]/","");                       //strip out /*
                value= value.replaceAll("/[–]/","");                            //Strip out –.
                value= value.replaceAll("/[#]/","");                   //Strip out #.
                value= value.replaceAll("/[ +]/","");                //Strip out spaces.
                value= value.replaceAll("select","");       //Strip out spaces.
                value= value.replaceAll("/union/s","");         //Strip out union
                value= value.replaceAll("UNION","");      //Strip out UNION
                value= value.replaceAll("SELECT","");       //Strip out SELECT
                value= value.replaceAll("Union","");         //Strip out Union   
