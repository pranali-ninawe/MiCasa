...
<!--                <nav class="my-2 my-md-0 mr-md-3 pl-5">
                ...
                <nav class="col-sm-2 d-none d-sm-block bg-light sidebar">
                    ...
                    <div class="sidebar-sticky">
                      <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="customerpayment.htm">
                    ...
                    <div class="col-sm-8" id="profile">
                        <h3 class="container-header">Payment History</h3>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach var="payment" items="${custrent}">
                <tr>
                  <td><c:out value="${payment.getRentId()}" /></td>
                  ...
                  <td><c:out value="${payment.getAmount()}" /></td>
                        ...
                        <p><a href="customerpayment.htm"> &lt;&lt;Go Back</a></p>  
          </div>          
          </div>
          </div>
        </div>
